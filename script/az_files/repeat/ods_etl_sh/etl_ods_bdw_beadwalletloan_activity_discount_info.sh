...
mysql_table=activity_discount_info
hive_external_table=ods_bdw_beadwalletloan_activity_discount_info

sqltemp=`cat /home/dispatch/Project/data-etl-sloth/schedule/etl_script/etl/ods_mysql_hive/ods_regular_table/etl_ods_bdw_beadwalletloan_activity_discount_info.sql`
v_dt=$1
end_dt=$2
...
beeline -u "jdbc:hive2://10.50.40.4:10000/ods" -n hive -p asdasd110.0 -e "msck repair table ods.ods_bdw_beadwalletloan_activity_discount_info"
